...
function TerritoryItemWiseAchievement() {
    ...
    const columns = useMemo(
        () => [
            ...
            { accessorKey: 'value', header: 'Value (Rs.)' },
        ],
        []
    )
        ...
        <div className="space-y-6">
            ...
            <Card className="p-6 rounded-2xl shadow-lg bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                ...
                <div className="mt-6 flex justify-center sm:justify-end">
                    <Button type="submit" variant="solid" className="px-6 py-2 text-sm rounded-xl">
                        Apply Filters
                    </Button>
                </div>
            </Card>
            ...
            <Card className="p-6 rounded-xl shadow-md bg-white dark:bg-gray-800">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                        <Button className="text-sm flex items-center gap-2" onClick={handleExport}>
...
export default TerritoryItemWiseAchievement
