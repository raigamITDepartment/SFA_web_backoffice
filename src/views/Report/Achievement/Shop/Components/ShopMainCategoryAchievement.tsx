...
function ShopMainCategoryAchievement() {
  ...
  const handleExport = () => {
          ...
          XLSX.utils.book_append_sheet(workbook, worksheet, 'MainCategoryReport')
          XLSX.writeFile(workbook, 'MainCategoryAchievement.xlsx')
      }
...
export default ShopMainCategoryAchievement
