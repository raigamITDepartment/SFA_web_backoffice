...
const OutletEdit = () => {
    ...
    useEffect(() => {
        // Sample category data; replace with API if needed
        const sampleCategoryData = [
            { id: 1, outletCategoryName: 'Small Bakery', isActive: true },
            { id: 2, outletCategoryName: 'Large Bakery', isActive: true },
            { id: 3, outletCategoryName: 'Grocery', isActive: true },
            { id: 4, outletCategoryName: 'Small Whole Sale', isActive: true },
            { id: 5, outletCategoryName: 'Large Whole Sale', isActive: true },
            { id: 6, outletCategoryName: 'Co-Operative', isActive: true },
            { id: 7, outletCategoryName: 'Super Market', isActive: true },
            { id: 8, outletCategoryName: 'Hotel or Others', isActive: true },
            { id: 9, outletCategoryName: 'Canteen', isActive: true },
            { id: 10, outletCategoryName: 'Pharmacy', isActive: true },
            { id: 11, outletCategoryName: 'Super Market', isActive: true },
            { id: 12, outletCategoryName: 'Co-op City', isActive: true },
            { id: 13, outletCategoryName: 'Beauty Salons', isActive: true },
            { id: 14, outletCategoryName: 'Ayurveda', isActive: true },
            { id: 15, outletCategoryName: 'Fancy House', isActive: true },
            { id: 16, outletCategoryName: 'Textile Shop', isActive: true },
            { id: 17, outletCategoryName: 'School', isActive: true },
        ]
    ...
    useEffect(() => {
        if (outletData && categoryOptions.length > 0) {
            const matchedCategory = categoryOptions.find(
                (cat) =>
                    cat.outletCategoryName.toLowerCase() ===
                    outletData.outletCategoryName.toLowerCase(),
            )
            ...
            reset({
                ...
                displayOrder: outletData.outletSequence,
                ...
                status: outletData.isClose,
                isNew: outletData.isNew,
                vatNum: outletData.vatNum,
                created: outletData.created,
                imgList: outletData.imagePath
                    ? [
                          {
                              id: String(outletData.id),
                              name: 'Outlet Image',
                              img: outletData.imagePath,
                          },
                      ]
                    : [],
            })
            ...
            setMapCoords({
                lat: String(outletData.latitude),
                lng: String(outletData.longitude),
            })
        }
            ...
            <Card bordered={false} className="w-full max-w-5xl">
                ...
                <Form size="sm" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <FormItem label="Outlet Dispaly Order">
                            <Controller
                                name="displayOrder"
                                control={control}
                                render={({ field }) => <Input {...field} />}
                        ...
                        <FormItem label="Created Date&Time">
                            <Controller
                                name="created"
                                control={control}
                                render={({ field }) => <Input {...field} />}
