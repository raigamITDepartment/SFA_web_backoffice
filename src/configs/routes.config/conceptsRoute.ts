...
const conceptsRoute: Routes = [
    ...
    //     component: lazy(
    //         () => import('@/views/SalesDetails/customers/CustomerList'),
    //     ),
    //     authority: [ADMIN, USER],
    // },
    // {
    ...
    //     component: lazy(
    //         () => import('@/views/SalesDetails/customers/CustomerEdit'),
    //     ),
    //     authority: [ADMIN, USER],
    //     meta: {
    //         header: {
    ...
    //     component: lazy(
    //         () => import('@/views/SalesDetails/customers/CustomerCreate'),
    //     ),
    //     authority: [ADMIN, USER],
    //     meta: {
    //         header: {
    ...
    //     component: lazy(
    //         () => import('@/views/SalesDetails/customers/CustomerDetails'),
    //     ),
    //     authority: [ADMIN, USER],
    //     meta: {
    //         pageContainerType: 'contained',
